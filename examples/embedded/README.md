...
| [`FakeLlmChatDemo`](src/main/java/io/streamlit4j/examples/FakeLlmChatDemo.java) | [text](../../docs/public/reference/text.md) (markdown), [inputs](../../docs/public/reference/inputs.md) (chat input), [control](../../docs/public/reference/control.md) (state), streamed chat tokens, chat controls, tool results |
