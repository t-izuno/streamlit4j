 ...
 *            owning session id
 * @param widgetId
 *            source widget id (file uploader)
 * @param filename
 ...
 */
public record FileUpload(int v, String type, String sessionId, String widgetId, String filename, String mimeType,
        String contentBase64) implements Envelope {
     ...
     */
    public static FileUpload of(String sessionId, String widgetId, String filename, String mimeType,
