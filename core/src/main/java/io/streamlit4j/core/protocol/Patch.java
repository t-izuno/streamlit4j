 ...
 *
 * @param op
 *            {@code "replace"} / {@code "insert"} / {@code "remove"}
 * @param path
 *            JSON-pointer-like path to the target node
 * @param node
 *            replacement / insertion node; {@code null} for {@code remove}
 */
