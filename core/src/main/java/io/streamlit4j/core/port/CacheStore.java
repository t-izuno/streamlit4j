...
/**
 * Port for a key/value cache backing {@code St.cacheData} and
 * {@code St.cacheResource}. Implementations decide eviction policy
 * (TTL is honored when supplied).
 */
public interface CacheStore {
     ...
     * @param key cache key (caller-defined namespace)
     * @param ttl maximum lifetime of a freshly loaded entry
     * @param loader supplier invoked when no fresh entry exists
