...
/**
 * Typed accessor over a session's mutable key/value state map. Exposed to
 * scripts via {@code St.state()} for free-form data sharing across reruns.
 */
public final class SessionState {
     ...
     *
     * @param store backing map (mutated through this accessor)
     */
     ...
     * @param key state key
     * @param type expected runtime type
     * @param fallback default returned when no compatible value exists
