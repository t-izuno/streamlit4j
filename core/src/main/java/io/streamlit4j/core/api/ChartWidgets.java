...
final class ChartWidgets {
    ...
    static void lineChart(List<Map<String, Object>> data) {
        emit("line_chart", widgetId("line_chart", data), Map.of("data", data));
    }

    static void barChart(List<Map<String, Object>> data) {
        emit("bar_chart", widgetId("bar_chart", data), Map.of("data", data));
    }

    static void areaChart(List<Map<String, Object>> data) {
        emit("area_chart", widgetId("area_chart", data), Map.of("data", data));
    }

    static void scatterChart(List<Map<String, Object>> data) {
        emit("scatter_chart", widgetId("scatter_chart", data), Map.of("data", data));
    }
}
