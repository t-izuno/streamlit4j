...
/**
 * Process-wide access points for the data and resource cache stores. Allows host applications (Spring Boot starter,
 * CLI) to swap implementations without changing the public {@code St.cacheData} / {@code St.cacheResource} API.
 */
