...
/**
 * Process-wide access point for the active {@link DownloadStore}. Allows host applications (Spring Boot starter, CLI)
 * to swap implementations without changing the {@code St.downloadButton(byte[]...)} API.
 */
